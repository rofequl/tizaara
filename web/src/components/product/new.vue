              ...
              <div class="collapse show" id="business-type">
                <ul>
                  <li v-for="businessType in business_typeList" :key="businessType.id">
                    <a href="javascript:void(0)" :class="business_type == businessType.name?'font-weight-bold':''" @click="business_type=businessType.name">{{ businessType.name }}</a>
                  </li>
                </ul>
              </div>
            </div>
                          ...
                          <div class="col-sm-5" style="border-left: 1px solid #ddd;">
                            <div class="cat-2">
                              <h4 v-if="product.user">
                                <a href="javascript:void(0)" @click="companyProfilePage(product.user.company_basic_info)">
